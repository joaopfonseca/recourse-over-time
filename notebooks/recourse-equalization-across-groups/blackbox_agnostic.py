"""
Taken from https://github.com/vgupta123/recourse-equalization/tree/master
"""
...
def read_CSV(filepath, k, pct, rstate=None):
    ...
    return df, d, ntr, ntst # dictionary of data with keys (trainx, testx, traingrp, testgrp, trainy, testy), number of features, number of training samples, number of test samples
...
class LimeTabularClassification(object):
    ...
    def cal_distance(self, data_rows, predict_fn, num_samples=5000, num_features=10, distance_metric='euclidean', neighbors=(None, [])):
        ...
        for i in range(n):
            ...
            distsnpreds[i] = np.array([d, s, p.squeeze()])
        # print(ss)
